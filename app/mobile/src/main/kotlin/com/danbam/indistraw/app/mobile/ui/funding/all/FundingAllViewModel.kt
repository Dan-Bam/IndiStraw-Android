...
) : ContainerHost<com.danbam.indistraw.app.mobile.ui.funding.all.FundingAllState, Unit>, ViewModel() {
    override val container = container<com.danbam.indistraw.app.mobile.ui.funding.all.FundingAllState, Unit>(
        com.danbam.indistraw.app.mobile.ui.funding.all.FundingAllState()
    )
